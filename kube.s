...
"".init t=1 size=61 args=0x0 locals=0x0
	0x0000 00000 (./example/kube.go:9)	TEXT	"".init(SB), $0-0
	0x0000 00000 (./example/kube.go:9)	MOVQ	(TLS), CX
	0x0009 00009 (./example/kube.go:9)	CMPQ	SP, 16(CX)
	0x000d 00013 (./example/kube.go:9)	JLS	54
	0x000f 00015 (./example/kube.go:9)	NOP
	0x000f 00015 (./example/kube.go:9)	NOP
	0x000f 00015 (./example/kube.go:9)	FUNCDATA	$0, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x000f 00015 (./example/kube.go:9)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x000f 00015 (./example/kube.go:9)	MOVBLZX	"".initdone·(SB), AX
	0x0016 00022 (./example/kube.go:9)	CMPB	AL, $1
	0x0018 00024 (./example/kube.go:9)	JLS	$0, 27
	0x001a 00026 (./example/kube.go:9)	RET
	0x001b 00027 (./example/kube.go:9)	JNE	$0, 34
	0x001d 00029 (./example/kube.go:9)	PCDATA	$0, $0
	0x001d 00029 (./example/kube.go:9)	CALL	runtime.throwinit(SB)
	0x0022 00034 (./example/kube.go:9)	MOVB	$1, "".initdone·(SB)
	0x0029 00041 (./example/kube.go:9)	PCDATA	$0, $0
	0x0029 00041 (./example/kube.go:9)	CALL	fmt.init(SB)
	0x002e 00046 (./example/kube.go:9)	MOVB	$2, "".initdone·(SB)
	0x0035 00053 (./example/kube.go:9)	RET
	0x0036 00054 (./example/kube.go:9)	NOP
	0x0036 00054 (./example/kube.go:9)	CALL	runtime.morestack_noctxt(SB)
	0x003b 00059 (./example/kube.go:9)	JMP	0
